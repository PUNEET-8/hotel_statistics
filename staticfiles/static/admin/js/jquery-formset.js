    ...
    a.fn.formset = function(c) {
                ...
                m.find("a." + l.deleteCssClass).click(function() {
                    ...
                    if (n.length) {
                        ...
                        for (var p = 0, q = o.length; p < q; p++) {
                            b(o.eq(p), p);
                            o.eq(p).find("input,select,textarea,label").each(function() {
                                k(a(this), l.prefix, p)
                            })
                        }
                    }
        ...
        if (j.length) {
            ...
            if (l.formTemplate) {
                ...
                h = a("." + l.formCssClass + ":last").clone(true).removeAttr("id");
            ...
            g.click(function() {
                var n = parseInt(a("#id_" + l.prefix + "-TOTAL_FORMS").val()),
                    ...
                    m = a(this).parents("tr." + l.formCssClass + "-add").get(0) || this;
                b(o, n);
