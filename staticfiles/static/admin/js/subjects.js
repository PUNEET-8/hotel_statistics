...
Category.extend({
    ...
    fetchTable: function(){
        dataTable =  $('#data-table-category').DataTable({
            ...
            dom: 'Bfrtip',
            "ajax": {
                "url": $global_endpoint+"categories/list-subject"
    ...
    deleteRecord: function(control){
        ...
        swal({
            ...
            if (willDelete) {
                var subject_id = $(control).attr('data-key');
                $.get($global_endpoint+'categories/'+subject_id+"/deleteSubject",function(response, code){
