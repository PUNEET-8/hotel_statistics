...
Offers.extend({
    ...
    fetchTable: function(){
        dataTable =  $('#data-table-offers').DataTable({
            ...
            dom: 'Bfrtip',
            "ajax": {
                "url": $global_endpoint+"bookings/used_offer_list_api"
            },
            "type": "GET",
            "dataType": 'json',
            "contentType": 'application/json; charset=utf-8',
            "columns": [
                { "data": "booking_student__email" },
                { "data": "booking_UsedOffer_offer_offer_title" },
                { "data": "action"}
    ...
    markactive: function(obj){
        ...
        $.get('/master-admin/bookings/'+offer_id+'/mark?status='+$(obj).is(":checked"), function(response, code){
