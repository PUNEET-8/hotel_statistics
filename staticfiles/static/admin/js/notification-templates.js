...
EmailTemplates.extend({
    ...
    fetchTable: function(){
        dataTable =  $('#data-table-email-templates').DataTable({
            ...
            dom: 'Bfrtip',
            "ajax": {
                "url": $global_endpoint+"bookings/notification-templates/list-api"
            },
            "type": "GET",
            "dataType": 'json',
    ...
    deleteRecord: function(control){
        swal({
            ...
            if (willDelete) {
                 var notification_template_id = $(control).attr('data-key');
                 console.log("notification_template_id", notification_template_id);
                $.get($global_endpoint+'bookings/notification-templates/'+notification_template_id+"/delete",function(response){
